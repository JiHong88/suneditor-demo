...
import { Check, Play, Sparkles, Table, ImageIcon, Code2, Palette, Type, Link, Video, FileText, Languages, Shield, Accessibility } from "lucide-react";
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {category.features.map((feature) => (
                  <Card
                    ...
                    onClick={() => setSelectedDemo(feature.demo)}
                  >
      ...
      {selectedDemo && (
        <section className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <motion.div
            ...
            className="bg-background rounded-lg shadow-2xl max-w-4xl w-full m-4 max-h-[80vh] overflow-auto"
          >
        ...
        <Card className="bg-gradient-to-r from-primary/5 to-secondary/5">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Start building with these powerful features in your own project
            </p>
