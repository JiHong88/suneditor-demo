...
/* ── Source code strings (displayed in CodeBlock) ──── */

const CODE_WORDCOUNT = `import { interfaces } from "suneditor";
...
const CODE_COLORPALETTE = `import { interfaces, helper } from "suneditor";
import type { SunEditor } from "suneditor/types";
...
const CODE_HASHTAG = `import { interfaces, helper } from "suneditor";
import type { SunEditor } from "suneditor/types";
...
const CODE_ZOOMLEVEL = `import { interfaces } from "suneditor";
import type { SunEditor } from "suneditor/types";
...
const CODE_EMOJI = `import { interfaces, modules } from "suneditor";
import type { SunEditor } from "suneditor/types";
...
const CODE_INFOPOPUP = `import { interfaces, modules, helper } from "suneditor";
import type { SunEditor } from "suneditor/types";
...
const CODE_TEXTSCALE = `import { interfaces, helper } from "suneditor";
import type { SunEditor } from "suneditor/types";
