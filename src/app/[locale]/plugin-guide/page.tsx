...
import { Code2, Puzzle, Play, BookOpen, Download, Github, Star, Package, Settings, Wrench, Lightbulb, ArrowRight, ExternalLink } from "lucide-react";
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <h1 className="text-4xl font-bold tracking-tight md:text-5xl">
            SunEditor Plugin Guide
          </h1>
          <p className="mt-4 text-lg text-muted-foreground">
            Learn how to extend SunEditor with custom plugins. From simple toolbar buttons to complex dialog-based features.
          </p>
                    ...
                    <Card key={example.name} className="h-full">
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant={
                            example.difficulty === 'Beginner' ? 'secondary' :
        ...
        >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Common patterns and structures for different types of plugins
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Always include proper error handling for user inputs
                  </p>
                </div>
                <Separator />
                <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full justify-start" asChild>
                  <a href="https://github.com/JiHong88/SunEditor/tree/master/src/plugins" target="_blank">
                    Source Code
          ...
          <Card className="bg-gradient-to-r from-primary/5 to-secondary/5">
            <CardContent className="p-8 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Button variant="outline" asChild>
                  <a href="/docs/plugin-api">Plugin API Docs</a>
                </Button>
