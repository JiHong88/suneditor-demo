...
const groupAccents = [
  ...
  { border: "border-violet-400", bg: "bg-violet-500/10", text: "text-violet-600 dark:text-violet-400", dot: "bg-violet-400" },
  { border: "border-emerald-400", bg: "bg-emerald-500/10", text: "text-emerald-600 dark:text-emerald-400", dot: "bg-emerald-400" },
  { border: "border-amber-400", bg: "bg-amber-500/10", text: "text-amber-600 dark:text-amber-400", dot: "bg-amber-400" },
        ...
        <div className="flex items-center gap-1.5 flex-1 min-w-0">
          {hasChildren ? (
            <span
              ...
              onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); handleArrowClick(e as unknown as React.MouseEvent); } }}
            ...
            <span className={cn("w-1.5 h-1.5 rounded-full flex-shrink-0 ml-0.5 mr-1", isSelected ? accent.dot : "bg-foreground/15")} />
          )}
