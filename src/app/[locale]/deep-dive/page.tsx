...
import { BookOpen, Cpu, Zap, Network, Eye, Code2, Database, Settings, ArrowDown, ArrowRight, Activity, Layers, GitBranch } from "lucide-react";
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Explore the internal architecture, design patterns, and technical implementation details of SunEditor v3.
          </p>
        </motion.div>
      </section>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">
                        {topic.sections[selectedSection]?.title}
                      </CardTitle>
                      <CardDescription>
                        {topic.sections[selectedSection]?.content}
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
        ...
        >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Step-by-step breakdown of how SunEditor processes user interactions
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Plugins are loaded only when first used, reducing initial bundle size
                  </p>
                </div>
                <Separator />
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Single event listener handles multiple elements, reducing memory usage
                  </p>
                </div>
                <Separator />
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Large documents render only visible portions for better performance
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Event listeners and references are cleaned up on destroy
                  </p>
                </div>
                <Separator />
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Undo/redo history has configurable size limits to prevent memory bloat
                  </p>
                </div>
                <Separator />
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    WeakMaps used for DOM element associations to prevent memory leaks
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent className="p-8 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Button variant="outline" asChild>
                  <a href="/plugin-guide">Plugin Development</a>
                </Button>
