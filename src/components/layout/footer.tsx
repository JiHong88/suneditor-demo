...
export default function Footer({ version = "" }: FooterProps) {
	...
	return (
		<footer
			role='contentinfo'
			className='pb-20 border-t border-slate-200/60 dark:border-slate-700/50 bg-slate-50/60 dark:bg-slate-900/30'
		>
			<div className='max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-slate-600 dark:text-slate-300'>
				<div>
					<div className='mb-3 flex items-center gap-2'>
						...
						<span className='rounded-md border border-slate-300/60 dark:border-slate-600/60 px-2 py-0.5 text-xs'>
							{version}
						</span>
					</div>
				...
				<div>
					...
					<p className='my-4 mb-2'>
						<Link href='https://github.com/JiHong88/suneditor?tab=MIT-1-ov-file'>{t("license")}</Link>
					</p>
